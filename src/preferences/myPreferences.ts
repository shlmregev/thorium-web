...
export const myPreferences: ThPreferences<DefaultKeys> = createPreferences<DefaultKeys>({
...
//  locale: "en",
  ...
  typography: {
    minimalLineLength: null, // null means no lower limit (enforce column count)
    optimalLineLength: 55, // number of characters. If auto layout, picks colCount based on this
    maximalLineLength: null, // null means no upper limit (enforce column count)
    pageGutter: 20
  },
  theming: {
    header: {
